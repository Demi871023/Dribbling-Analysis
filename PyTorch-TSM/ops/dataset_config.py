...
def return_dribbling(modality):
    filename_categories = 'dribbling/category.txt'
    if modality == 'RGB':
        root_data = ROOT_DATASET + '/dribbling/dribbling-frames'
        filename_imglist_train = 'dribbling/train_videofolder.txt'
        filename_imglist_val = 'dribbling/valid_videofolder.txt'
        prefix = '{:06d}.jpg'
    elif modality == 'Flow':
...
def return_dataset(dataset, modality):
    dict_single = {'jester': return_jester, 'something': return_something, 'somethingv2': return_somethingv2,
                   ...
                   'kinetics': return_kinetics, 'dribbling': return_dribbling }
