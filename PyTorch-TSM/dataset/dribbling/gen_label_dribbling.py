...
if __name__ == '__main__':
    dataset_name = 'dribbling'  # 'jester-v1'
    ...
    files_input = ['%s-train.json' % dataset_name, '%s-valid.json' % dataset_name]
    files_output = ['train_videofolder.txt', 'valid_videofolder.txt']
    for (filename_input, filename_output) in zip(files_input, files_output):
        ...
        for item in data:
            ...
            if 'test' not in filename_input:
                ...
                idx_categories.append(dict_categories[item['label']])
            else:
        ...
        for i in range(len(folders)):
            ...
            dir_files = os.listdir(os.path.join('dribbling-frames', curFolder))
